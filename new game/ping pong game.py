...
# colours and gobal stuffs
bg_color = pygame.Color('#8a5a66')
accent_color = (27,35,43)
basic_font = pygame.font.Font('freesansbold.ttf', 32)
plob_sound = pygame.mixer.Sound("pong.mp3")
...
while True:
    ...
    os.path.join('assets', 'bg.jpg')), (screen_width, screen_height))
	WIN.blit(SPACE, (0, 0))
	pygame.draw.rect(screen,accent_color,middle_strip)
	# start game
	game_manager.run_game()

	# Rendering and fps things
	pygame.display.flip()
	clock.tick(144)